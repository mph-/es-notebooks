...
def risetime_demo3_plot(model=models[0], Cl_pF=5, Rs=50, t_ns=1e-9):
    ...
    Vo, Io, Vl = model_case.step_rise(tx, Cload=Cl_pF * 1e-12, Rs=Rs)
...
def risetime_demo3():
    interact(risetime_demo3_plot, model=models, Cl_pF=(5, 50, 5),
             t_ns=(0, 2, 0.2), Rs=[0, 50, 100, 500, 1000],
