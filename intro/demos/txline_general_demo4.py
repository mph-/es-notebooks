...
def txline_general_demo4_plot(Z0=60, Rs=20, Rl=1e6, t_ns=0):
...
def txline_general_demo4():
    interact(txline_general_demo4_plot, Z0=[50, 60, 80, 100],
