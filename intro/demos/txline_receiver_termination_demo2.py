...
def txline_receiver_termination_demo2_plot(Z0=60, Rs=20, Vt=0, t_ns=0):
...
def txline_receiver_termination_demo2():
    interact(txline_receiver_termination_demo2_plot, Z0=[50, 60, 80, 100],
